...
st.set_page_config(page_title="Analyze Satellite Imagery", page_icon="!")
st.sidebar.header("🛰️ Analyze Satellite Imagery")


st.title("Ship Detection in Satellite Images")

st.write("Upload a large image taken from a satellite, and press on submit, our model will identify all ships on that image and highlight them with red boxes.")
